namespace CelestialLeague.Shared.Enum
{
    ...
    public enum PacketType
    {
        ...
        Disconnect = 92,
        // DisconnectResponse = 93, Disconnect is now used to show feedback on why you were disconnected
        Ping = 94,
        PingResponse = 95,
        Error = 96,
        Acknowledgment = 97,
        ServerStatus = 98,
        ServerShutdown = 99,
        // ForceDisconnect = 100, Disconnect is now used to show feedback on why you were disconnected
